...
class QuestionPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        Label(self, text='1. H&E Acceptable?', background='white',
              font='Arial 14').place(anchor='w', relx=.4, rely=.1)

        # label for question 2
        Label(self, text='2. Negative Control Acceptable?', background='white',
              font='Arial 14').place(anchor='w', relx=.4, rely=.17)

        # label for question 3
        Label(self, text='3. Case Morphology Acceptable?', background='white',
              font='Arial 14').place(anchor='w', relx=.4, rely=.24)

        # label for question 4
        Label(self, text='4. Background Acceptable?', background='white',
              font='Arial 14').place(anchor='w', relx=.4, rely=.31)

        # label for question 5
        Label(self, text='5. % Cell Staining (Raw Score, 0-100):', background='white',
              font='Arial 14').place(anchor='w', relx=.4, rely=.38)

        # label for question 6
        Label(self, text='6. Case Status:', background='white',
              font='Arial 14').place(anchor='w', relx=.4, rely=.45)

        # label for comments
        Label(self, text='7. Comments:', background='white',
              font='Arial 14').place(anchor='w', relx=.4, rely=.52)

        comments = StringVar()

        # entry field for comments
        Entry(self, textvariable=comments, background='#e6e6e6', font='Arial 20', ).place(
        ...
        def start_test():
            ...
            Label(self, text='Case #', background='light gray',
                  font='Arial 18').place(anchor='w', relx=.03, rely=.3, width='75', height='50')
            ...
            Label(self, textvariable=number, font='Arial 18',
                  background='light gray').place(anchor='w', relx=.12, rely=.3, width='25', height='50')

        # button calls start_test function
        Button(self, text='Start Test', bg='green', fg='black', font='Arial 16 bold',
        ...
        Button(self, text='Next Case', bg='grey', fg='black',
               font='Arial 16 bold').place(anchor='w', relx=0.03, rely=0.8, width='120', height='60')

        # button calls end_test function, still need to add this function
        Button(self, text='End Test', bg='red', fg='black',
               font='Arial 16 bold').place(anchor='w', relx=0.2, rely=0.8, width='120', height='60')

        # button calls save_answers function, still need to add this function
        Button(self, text='Save Answers', bg='blue', fg='black',
               font='Arial 16 bold').place(anchor='w', relx=0.4, rely=0.875, width='120', height='40')
