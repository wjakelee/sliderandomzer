...
# 2. Second is the button clear 'btn_clear' function clears the input field or previous PIN using the button "C"
def btn_clear():
    global expression
    expression = ""
    input_text.set("")

# 3. Third and the final function is button enter
#figure out how to get enter button to work

def btn_enter(enter):
    global expression
    expression = expression + str(enter)
    input_text.set(expression)
    expression = ""
